...
public class Chakravyuh_Chess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chakravyuh_chess);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Chakravyuh_Chess.this, R.style.AppCompatAlertDialog);
