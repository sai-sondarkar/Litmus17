...
public class Scifun_Object_Decor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scifun__object__decor);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Scifun_Object_Decor.this, R.style.AppCompatAlertDialog);
