...
public class Register_Chakravyuh extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
//sports main
    ...
    public static final String NAME_KEY="entry_1024283095";
    public static final String CONTACT_KEY="entry_1649662317";
    public static final String EMAIL_KEY="entry_1086375728";
    public static final String COLLEGE_KEY="entry_781739086";
    public static final String GENDER_KEY="entry_609027521";
    public static final String TECHNO_KEY="entry_2112508720";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_chakravyuh);
        ...
        categories.add(getString(R.string.title_activity_c1));
        categories.add(getString(R.string.title_activity_c2));
        categories.add(getString(R.string.title_activity_c3));
        categories.add(getString(R.string.title_activity_c4));
        categories.add(getString(R.string.title_activity_c5));
        categories.add(getString(R.string.title_activity_c6));
        categories.add(getString(R.string.title_activity_c8));
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (parent.getId())
        {
            case R.id.spinner : techno = parent.getItemAtPosition(position).toString();
    ...
    private class PostDataTask extends AsyncTask<String, Void, Boolean> {
        ...
        private ProgressDialog dialog = new ProgressDialog(Register_Chakravyuh.this);
        ...
        protected Boolean doInBackground(String... contactData) {
            ...
            try {
                ...
                postBody = NAME_KEY+"=" + URLEncoder.encode(name, "UTF-8") +
                        ...
                        "&" + GENDER_KEY+ "=" + URLEncoder.encode(city1,"UTF-8") +
