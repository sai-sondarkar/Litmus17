...
public class Chakravyuh_Basketball extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chakravyuh_basketball);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Chakravyuh_Basketball.this, R.style.AppCompatAlertDialog);
