...
public class Magnif_Tug_Of_War extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magnif__tug__of__war);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Magnif_Tug_Of_War.this, R.style.AppCompatAlertDialog);
