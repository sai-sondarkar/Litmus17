...
public class Scifun_Best_Out_Of_Waste extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scifun__best__out__of__waste);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Scifun_Best_Out_Of_Waste.this, R.style.AppCompatAlertDialog);
