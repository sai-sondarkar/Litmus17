...
public class Magnif_Quiz_Tactic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magnif__quiz__tactic);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Magnif_Quiz_Tactic.this, R.style.AppCompatAlertDialog);
