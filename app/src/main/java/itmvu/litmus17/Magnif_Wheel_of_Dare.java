...
public class Magnif_Wheel_of_Dare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magnif__wheel_of__dare);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Magnif_Wheel_of_Dare.this, R.style.AppCompatAlertDialog);
