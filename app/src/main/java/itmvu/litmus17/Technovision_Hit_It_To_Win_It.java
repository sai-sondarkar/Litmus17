...
public class Technovision_Hit_It_To_Win_It extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_technovision_hit_it_to_win_it);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Technovision_Hit_It_To_Win_It.this, R.style.AppCompatAlertDialog);
