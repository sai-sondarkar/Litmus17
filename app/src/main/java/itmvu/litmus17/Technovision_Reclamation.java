...
public class Technovision_Reclamation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_technovision_reclamation);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Technovision_Reclamation.this, R.style.AppCompatAlertDialog);
        builder.setTitle("LOCATION");
        builder.setMessage("Workshop,ITM Vocational Univeristy");
