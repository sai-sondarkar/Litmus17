...
public class Magnif_Clean_The_Board extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magnif__clean__the__board);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Magnif_Clean_The_Board.this, R.style.AppCompatAlertDialog);
