...
public class Kalakriti_Curtain_Up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalakriti_curtain_up);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Kalakriti_Curtain_Up.this, R.style.AppCompatAlertDialog);
