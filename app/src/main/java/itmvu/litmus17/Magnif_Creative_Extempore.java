...
public class Magnif_Creative_Extempore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magnif__creative__extempore);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Magnif_Creative_Extempore.this, R.style.AppCompatAlertDialog);
