...
public class Chakravyuh_Football extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chakravyuh_football);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Chakravyuh_Football.this, R.style.AppCompatAlertDialog);
