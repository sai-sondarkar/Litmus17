...
public class Magnif_Lakhati_Maro_Bottle_Pado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magnif__lakhati__maro__bottle__pado);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Magnif_Lakhati_Maro_Bottle_Pado.this, R.style.AppCompatAlertDialog);
