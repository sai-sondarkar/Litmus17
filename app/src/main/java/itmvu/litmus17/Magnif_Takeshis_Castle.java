...
public class Magnif_Takeshis_Castle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magnif__takeshis__castle);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Magnif_Takeshis_Castle.this, R.style.AppCompatAlertDialog);
