...
public class Kalakriti_Dancellenium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalakriti_dancellenium);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Kalakriti_Dancellenium.this, R.style.AppCompatAlertDialog);
