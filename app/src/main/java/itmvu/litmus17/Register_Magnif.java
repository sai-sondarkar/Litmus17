...
public class Register_Magnif extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
//mgnif regestration
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Spinner spinner = (Spinner) findViewById(R.id.spinner);
        ...
        categories.add(getString(R.string.title_activity_m1));
        categories.add(getString(R.string.title_activity_m2));
        categories.add(getString(R.string.title_activity_m3));
        categories.add(getString(R.string.title_activity_m4));
        categories.add(getString(R.string.title_activity_m5));
        categories.add(getString(R.string.title_activity_m6));
        categories.add(getString(R.string.title_activity_m7));
        categories.add(getString(R.string.title_activity_m8));
        categories.add(getString(R.string.title_activity_m9));
        categories.add(getString(R.string.title_activity_m10));
        categories.add(getString(R.string.title_activity_m11));
        categories.add(getString(R.string.title_activity_m12));
        categories.add(getString(R.string.title_activity_m13));
        categories.add(getString(R.string.title_activity_m14));
        categories.add(getString(R.string.title_activity_m15));
    ...
    private class PostDataTask extends AsyncTask<String, Void, Boolean> {
        ...
        private ProgressDialog dialog = new ProgressDialog(Register_Magnif.this);
