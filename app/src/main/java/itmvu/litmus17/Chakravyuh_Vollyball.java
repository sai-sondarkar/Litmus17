...
public class Chakravyuh_Vollyball extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chakravyuh_vollyball);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Chakravyuh_Vollyball.this, R.style.AppCompatAlertDialog);
