...
public class Scifun_Card_Creation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scifun__card__creation);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Scifun_Card_Creation.this, R.style.AppCompatAlertDialog);
