...
public class Technovision_Speeding_Machines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_technovision_speeding_machines);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Technovision_Speeding_Machines.this, R.style.AppCompatAlertDialog);
