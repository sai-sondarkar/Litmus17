...
public class Magnif_Wrist_Wrestling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magnif_wrist_wrestling);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Magnif_Wrist_Wrestling.this, R.style.AppCompatAlertDialog);
