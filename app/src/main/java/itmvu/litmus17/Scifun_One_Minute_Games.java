...
public class Scifun_One_Minute_Games extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scifun__one__minute__games);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Scifun_One_Minute_Games.this, R.style.AppCompatAlertDialog);
