...
public class Scifun_Clay_Modelling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scifun__clay__modelling);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Scifun_Clay_Modelling.this, R.style.AppCompatAlertDialog);
