...
public class Scifun_Painter_Paradise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scifun__painter__paradise);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Scifun_Painter_Paradise.this, R.style.AppCompatAlertDialog);
