...
public class Technovision_Fiery_Fighters extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_technovision_fiery_fighters);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Technovision_Fiery_Fighters.this, R.style.AppCompatAlertDialogStyle);
