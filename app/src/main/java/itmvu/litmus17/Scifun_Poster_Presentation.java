...
public class Scifun_Poster_Presentation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scifun__poster__presentation);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Scifun_Poster_Presentation.this, R.style.AppCompatAlertDialog);
