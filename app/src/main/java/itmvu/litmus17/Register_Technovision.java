...
public class Register_Technovision extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_technovision);
        ...
        categories.add(getString(R.string.title_activity_t1));
        categories.add(getString(R.string.title_activity_t2));
        categories.add(getString(R.string.title_activity_t3));
        categories.add(getString(R.string.title_activity_t4));
        categories.add(getString(R.string.title_activity_t5));
        categories.add(getString(R.string.title_activity_t6));
        categories.add(getString(R.string.title_activity_t7));
        categories.add(getString(R.string.title_activity_t8));
        categories.add(getString(R.string.title_activity_t9));
        categories.add(getString(R.string.title_activity_t10));
        categories.add(getString(R.string.title_activity_t11));
        categories.add(getString(R.string.title_activity_t12));
        categories.add(getString(R.string.title_activity_t13));
        categories.add(getString(R.string.title_activity_t14));
        categories.add(getString(R.string.title_activity_t15));
        categories.add(getString(R.string.title_activity_t16));
        categories.add(getString(R.string.title_activity_t17));
        categories.add(getString(R.string.title_activity_s1));
        categories.add(getString(R.string.title_activity_s2));
        categories.add(getString(R.string.title_activity_s3));
        categories.add(getString(R.string.title_activity_s4));
        categories.add(getString(R.string.title_activity_s5));
        categories.add(getString(R.string.title_activity_s6));
        categories.add(getString(R.string.title_activity_s7));
        categories.add(getString(R.string.title_activity_s8));
        categories.add(getString(R.string.title_activity_s9));
...
//        Toast.makeText(parent.getContext(), dept, Toast.LENGTH_LONG).show();
    ...
    private class PostDataTask extends AsyncTask<String, Void, Boolean> {
        ...
        private ProgressDialog dialog = new ProgressDialog(Register_Technovision.this);
