...
public class Chakravyuh_Girls_Gully_Cricket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chakravyuh_girls_gully_cricket);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Chakravyuh_Girls_Gully_Cricket.this, R.style.AppCompatAlertDialog);
