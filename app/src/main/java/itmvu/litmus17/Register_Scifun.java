...
public class Register_Scifun extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
//mgnif regestration
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register__scifun);
    ...
    private class PostDataTask extends AsyncTask<String, Void, Boolean> {
        ...
        private ProgressDialog dialog = new ProgressDialog(Register_Scifun.this);
