...
public class Magnif_Lit_The_Candle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magnif__lit__the__candle);
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(Magnif_Lit_The_Candle.this, R.style.AppCompatAlertDialog);
